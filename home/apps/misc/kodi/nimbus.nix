...
rec {
    ...
    guiSettings = ''
        <settings version="2">
            ...
            <setting id="locale.timezonecountry" default="true" />
            <setting id="locale.timezone" default="true">Europe/London</setting>
            ...
            <setting id="window.width">604</setting>
            <setting id="window.height">661</setting>
            ...
            <setting id="services.deviceuuid">813529ea-c046-480d-afb2-b52cc462fa7a</setting>
            ...
            <setting id="audiooutput.audiodevice">PIPEWIRE:Default|Default Output Device (PIPEWIRE)</setting>
            ...
            <setting id="audiooutput.passthroughdevice" default="true">Default</setting>
            ...
            <general>
                ...
                <systemtotaluptime>385</systemtotaluptime>
            </general>
            <resolutions />
